...
library(lubridate)
library(tidyverse)
source('D:/315Lab/CODE/DSSAT_simulation/functions/run_dssat.R')
source("D:/315Lab/CODE/DSSAT_simulation/functions/ChangeSOL.R")
...
GridMatch
# runDSSAT('D:/315Lab/Project/P03_ClimateChange/DSSAT48/Rice/')
# Crops to simulated
# crops = c("Rice", "Wheat", "Maize", "Soybean", "Taro", "Cabbage", "Sugarcane", "Tomato")
crops = "Maize"
simulated_year = 2019:2020
simulated_grids_index = 1:920
# crop <- "Taro"
